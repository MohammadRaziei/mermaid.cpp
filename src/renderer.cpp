...
void SvgVisitor::visit(MessageNode &node) {
    ...
    // Golden offsets: first message from_x=75 -> x1=76 (+1), to_x=275 -> x2=271 (-4)
    // second message from_x=275 -> x1=274 (-1), to_x=75 -> x2=79 (+4)
    // Determine direction
